 ...
 * @property {number} [price=1000000]      - Initial property price (in USD)
 * @property {number} [downPayment=20]     - Initial down payment (in percent)
 * @property {number} [loanPeriod=25]      - Initial loan period (in years)
 * @property {number} [interestRate=4]     - Initial interest rate (in percent)
 * @property {number} [minPrice=10000]     - Minimum allowed price (in USD)
 * @property {number} [maxPrice=2000000]   - Maximum allowed price (in USD)
 * @property {number} [minDownPayment=10]  - Minimum allowed down payment (in percent)
 * @property {number} [maxDownPayment=80]  - Maximum allowed down payment (in percent)
 * @property {number} [minLoanPeriod=1]    - Minimum loan period (in years)
 * @property {number} [maxLoanPeriod=30]   - Maximum loan period (in years)
 * @property {number} [minInterestRate=1]  - Minimum interest rate (in percent)
 * @property {number} [maxInterestRate=10] - Maximum interest rate (in percent)
 */
